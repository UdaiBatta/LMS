...
urlpatterns = [
    ...
    path("student/credentials/", student_credentials_view, name="student_credentials"),
    path("student/<int:pk>/reset-password/", reset_student_password, name="reset_student_password"),
    ...
    path("ajax/session-timeout-check/", session_timeout_check, name="session_timeout_check"),
